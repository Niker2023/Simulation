...
//        }
//
//        Coordinates getCoordinatesForAction(WorldMap worldMap, Coordinates currentCoordinate, Coordinates targetCoordinates, String targetMove) {
//
...
//            while (!queue.isEmpty()) {
//
//                Node currentNode = queue.poll(); //Работает со следующей ячейкой
//
...
//                    if (!graph.containsKey(adjacent) || pathCost < adjacentNode.getPathFromStart()) {
//                        adjacentNode.setPathFromStart(pathCost);
//                        adjacentNode.setPathToTarget(pathCost + heuristic(adjacentNode, new Node(targetCoordinates)));
//                        queue.add(adjacentNode);  //Добавляем текущую в очередь
//                    }
//                }
//            }
//            return currentCoordinate;
